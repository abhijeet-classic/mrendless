                        ...
                        <div class="six-columns six-offset">
                            <div class="content-left-margin-40">
                                ...
                                <h3 class="large-title-bold text-color-4">
                                    ...
                                    <span class="overlay-loading2 overlay-light-bg-1 tr-delay05">3D - Modelling</span><br>
                        ...
                        <div data-animation-container class="flex-container">
                            ...
                            <div class="twelve-columns text-center">
                                <b style="font-size: 50px"  >
                                    <b style="color: blue" data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="3D - Modelling">3D - Modelling</b><br><br>
                ...
                <div class="flex-min-height-inner">
                    ...
                    <div class="container top-bottom-padding-120">
                        ...
                        <div data-animation-container class="flex-container">
                            ...
                            <div class="twelve-columns text-center">
                                <b style="font-size: 50px">
                                    <b data-animation-child class="title-fill" data-animation="title-fill-anim" data-text="3D - Modelling Gallery">3D - Modelling Gallery</b><br><br>
